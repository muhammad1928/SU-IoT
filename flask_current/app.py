...
def get_weather_data(city):
    ...
    if response.status_code == 200:
        ...
        if current_time <= sunrise + 3600:  # Within 1 hour of sunrise
            ...
            reason = "It's around sunrise, so the color is warm orange to reflect the morning light."
            ...
            reason = "It's around sunset, so the color is golden to reflect the evening glow."
        else:
